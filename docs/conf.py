# -*- coding: utf-8 -*-
#
# Parsetron documentation build configuration file, created by
...
elif user_theme == THEME_RTD:
    import sphinx_rtd_theme
    html_theme_path = [sphinx_rtd_theme.get_html_theme_path()]
    html_theme = 'sphinx_rtd_theme'
elif user_theme == THEME_BOOTSTRAP:
...
# pixels large.
html_favicon = '_static/kitt-ai-32.ico'
...
htmlhelp_basename = 'Parsetrondoc'
...
latex_documents = [
  (master_doc, 'Parsetron.tex', u'Parsetron Documentation',
   u'KITT.AI', 'manual'),
]
...
man_pages = [
    (master_doc, 'parsetron', u'Parsetron Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Parsetron', u'Parsetron Documentation',
   author, 'Parsetron', 'One line description of project.',
   'Miscellaneous'),
]
